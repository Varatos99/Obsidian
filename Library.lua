...
local Library = {
    ...
    Scheme = {
        ...
        MainColor = Color3.fromRGB(40, 20, 55),
        AccentColor = Color3.fromRGB(120, 40, 160),
        Accent2Color = Color3.fromRGB(255, 210, 50),
        OutlineColor = Color3.fromRGB(160, 80, 200),
...
TabLabel.TextColor3 = Library.Scheme.WhiteColor
    ...
    function Window:Toggle(Value: boolean?)
		...
		-- BUGGED ANIMATION TEXT BROKEN UNTIL RESIZED MANUALLY --
